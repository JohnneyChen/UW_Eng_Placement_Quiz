...
chem.course_set.create(course_type='first', course='MTE 140 - Algorithms and Data Structures')
chem.course_set.create(course_type='first', course='MTE 120 - Circuits')
chem.course_set.create(course_type='first', course='MTE 119 - Statics')
chem.course_set.create(course_type='first', course='MTE 111 - Structure and Properties of Materials')
chem.course_set.create(course_type='first', course='MTE 100B – Seminar')
chem.course_set.create(course_type='first', course='GENE 121 - Digital Computation')
...
chem.course_set.create(course_type='first', course='MTE 100 - Mechatronics Engineering')

# Chemical engineering upper-year courses
chem.course_set.create(course_type='upper', course='MTE 544 – Autonomous Mobile Robots')
chem.course_set.create(course_type='upper', course='MTE 322 – Electromechanical Machine Design')
chem.course_set.create(course_type='upper', course='MTE 220 – Sensors and Instrumentation')
chem.course_set.create(course_type='upper', course='MTE 262 – Introduction to Microprocessors and Digital Logic')
