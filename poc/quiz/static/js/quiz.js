...
const isQuizComplete = ()=>{
  const completed1 = Object.values($('input[name="problem_type"]')).find(input=>input.checked)
  const completed2 = Object.values($('input[name="creative"]')).find(input=>input.checked)
  const completed3 = Object.values($('input[name="essay"]')).find(input=>input.checked)
  const completed4 = Object.values($('input[name="outdoors"]')).find(input=>input.checked)
  const completed5 = Object.values($('input[name="career"]')).find(input=>input.checked)
  const completed6 = Object.values($('input[name="group_work"]')).find(input=>input.checked)
  const completed7 = Object.values($('input[name="liked_courses"]')).find(input=>input.checked)
  const completed8 = Object.values($('input[name="disliked_courses"]')).find(input=>input.checked)
  const completed9 = Object.values($('input[name="programming"]')).find(input=>input.checked)
  const completed10 = Object.values($('input[name="join_clubs"]')).find(input=>input.checked)
  const completed11 = Object.values($('input[name="not_clubs"]')).find(input=>input.checked)
  const completed12 = Object.values($('input[name="liked_projects"]')).find(input=>input.checked)
  const completed13 = Object.values($('input[name="disliked_projects"]')).find(input=>input.checked)
  const completed14 = Object.values($('input[name="tv_shows"]')).find(input=>input.checked)
  const completed15 = Object.values($('input[name="alternative_degree"]')).find(input=>input.checked)
  const completed16 = Object.values($('input[name="expensive_equipment"]')).find(input=>input.checked)
  const completed17 = Object.values($('input[name="drawing"]')).find(input=>input.checked)
